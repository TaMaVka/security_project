...
config = dotenv_values(".env")  # укажите точный путь, если файл в другой директории; иначе просто название файла
#print(config)
...
if __name__ == "__main__":
    recipient_emails = ["davidsogom@mail.ru", "mariyat02@mail.ru", "arshanskiy777@mail.ru"]
    
    mails = [("Кения", "Привет! Это твой дядя из Кении"), ("Kenya Uncle", "Hello, it's your uncle from Kenya!"), ("Biba", "It's your brother - Biba!"), ("Sunlite!", "Санлайт закрывается!!")]

    for i in mails:
        for recipient_email in recipient_emails:
            send_email(recipient_email, i[0], i[1])
            time.sleep(10)